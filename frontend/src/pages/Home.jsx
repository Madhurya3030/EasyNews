      ...
      <div className="max-w-4xl mx-auto mt-10">
        ...
        <div className="mt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-zinc-900 border border-white/10 rounded-2xl h-48 flex items-center justify-center text-gray-500">
            ...
            <div className="bg-zinc-900 border border-white/10 rounded-2xl h-48 flex items-center justify-center text-gray-500">
              News Item Placeholder 3
            </div>
            <div className="bg-zinc-900 border border-white/10 rounded-2xl h-48 flex items-center justify-center text-gray-500">
              News Item Placeholder 4
            </div>
          </div>
        </div>
      </div>
